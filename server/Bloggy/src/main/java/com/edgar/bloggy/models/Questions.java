...
public class Questions {
	...
	@NotBlank(message= "you need a title for the questions")
	@Column
	...
	public Questions(@NotBlank(message = "you need a title for the questions") String title,
			@NotBlank(message = "the body can not be empty") String body, Date date, String photo) {
		super();
		this.title = title;
		this.body = body;
		this.date = date;
	...
	public String toString() {
		return "Questions [id=" + id + ", title=" + title + ", body=" + body + ", date=" + date + ", photo=" + photo
				+ "]";
	}
